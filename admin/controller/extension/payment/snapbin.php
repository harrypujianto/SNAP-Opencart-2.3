...
class ControllerExtensionPaymentSnapbin extends Controller {
  ...
  public function index() {
    ...
    $data['breadcrumbs'][] = array(
      ...
      'href' => $this->url->link('extension/payment/snapbin', 'token=' . $this->session->data['token'], true)
    );

    $data['action'] = $this->url->link('extension/payment/snapbin', 'token=' . $this->session->data['token'], true);
    ...
    $this->template = 'extension/payment/snapbin.tpl';
	...
	$this->response->setOutput($this->load->view('extension/payment/snapbin.tpl',$data));
