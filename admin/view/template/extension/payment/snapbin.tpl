...
<div class="page-header">
  <div class="container-fluid">
   <div class="pull-right">
    <button type="submit" form="form-midtrans-snapbin" data-toggle="tooltip" onclick="$('#form-midtrans-snapbin').submit();" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
	  ...
	  <div class="col-sm-3">
	   <select name="snapbin_geo_zone_id"  class="form-control">
		...
		<?php foreach ($geo_zones as $geo_zone) { ?>
		  <?php if ($geo_zone['geo_zone_id'] == $snapbin_geo_zone_id) { ?>
