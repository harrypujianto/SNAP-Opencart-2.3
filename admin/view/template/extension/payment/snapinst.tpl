...
<div class="page-header">
  <div class="container-fluid">
   <div class="pull-right">
    <button type="submit" form="form-midtrans-snapinst" data-toggle="tooltip" onclick="$('#form-midtrans-snapinst').submit();" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
 ...
 <div class="container-fluid">
   ...
   <div class="panel panel-default">
	...
	<div class="panel-body">
	 <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-midtrans-snapinst" class="form-horizontal">
	...
	<div class="form-group required v2_settings sensitive">
	  <label class="col-sm-2 control-label" for="input-min-txn"><?php echo $entry_min_txn; ?></label>
		<div class="col-sm-3">
		  <input type="text" name="snapinst_min_txn" value="<?php echo $snapinst_min_txn; ?>" id="input-merchant-id" class="form-control" />
		</div>
		<div class="col-sm-3">
