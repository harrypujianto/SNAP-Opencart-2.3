...
<div class="page-header">
  <div class="container-fluid">
   <div class="pull-right">
    <button type="submit" form="form-midtrans-snapio" data-toggle="tooltip" onclick="$('#form-midtrans-snapio').submit();" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
 ...
 <div class="container-fluid">
   ...
   <div class="panel panel-default">
	...
	<div class="panel-body">
	 <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-midtrans-snapio" class="form-horizontal">
	  ...
	  <label class="col-sm-2 control-label" for="input-mode"><?php echo $entry_environment; ?></label>
	    <div class="col-sm-3">
		  <select name="snapio_environment" id="input-mode" class="form-control">
			...
			<?php foreach ($options as $key => $value): ?>
			  <option value="<?php echo $key ?>" <?php if ($key == $snapio_environment) echo 'selected' ?> ><?php echo $value ?></option>
			<?php endforeach ?>
		  </select>
		</div>
		<div class="col-sm-3">
	...
	<div class="form-group required v2_settings sensitive">
	  <label class="col-sm-2 control-label" for="input-min-txn"><?php echo $entry_min_txn; ?></label>
		<div class="col-sm-3">
		  <input type="text" name="snapio_min_txn" value="<?php echo $snapio_min_txn; ?>" id="input-merchant-id" class="form-control" />
		</div>
		<div class="col-sm-3">
