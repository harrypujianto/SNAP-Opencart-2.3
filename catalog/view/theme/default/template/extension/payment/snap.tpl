...
mixpanel.init("<?php echo $mixpanel_key;?>");
  ...
  <script> 
    ...
    $.ajax({
      type: 'get',
      url: 'index.php?route=extension/payment/snap/process_order',
      cache: false,
      beforeSend: function() {
      ...
      success: function(data) {
        ...
        snap.pay(data, {
          onSuccess: function(result){
            trackResult(data, merch_id, 'fullpayment', 'success', result);
            changeResult('success', result);
            console.log(result.status_message);
            $("#payment-form").submit();
          },
          onPending: function(result){
            trackResult(data, merch_id, 'fullpayment', 'pending', result);
