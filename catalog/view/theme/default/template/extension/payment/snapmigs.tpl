...
mixpanel.init("<?php echo $mixpanel_key;?>");
  ...
  <script> 
    ...
    $.ajax({
      type: 'get',
      url: 'index.php?route=extension/payment/snapmigs/process_order',
      cache: false,
      beforeSend: function() {
      ...
      snap.pay(data, {
          onSuccess: function(result){
            trackResult(data, merch_id, 'cc_migs', 'success', result);
            changeResult('success', result);
            console.log(result.status_message);
            $("#payment-form").submit();
          },
          onPending: function(result){
            trackResult(data, merch_id, 'cc_migs', 'pending', result);
            changeResult('pending', result);
            console.log(result.status_message);
            $("#payment-form").submit();
          },
          onError: function(result){
            trackResult(data, merch_id, 'cc_migs', 'error', result);
          ...
          onClose: function(){
            trackResult(data, merch_id, 'cc_migs', 'close');
