...
class ModelExtensionPaymentSnapinstmigs extends Model {
  ...
  public function getMethod($address, $total) {
      ...
      $method_data = array(
        'code'       => 'snapinstmigs',
        'title'      => $this->config->get('snapinstmigs_display_name'),
		'sort_order' => $this->config->get('snapinstmigs_sort_order'),
		'terms' 	 => ''
      );
    }
