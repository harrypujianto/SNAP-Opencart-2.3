...
class ControllerExtensionPaymentSnapinstmigs extends Controller {
  ...
  public function index() {
    ...
    $data['text_loading'] = $this->language->get('text_loading');
  	...
  	$data['process_order'] = $this->url->link('extension/payment/snapinstmigs/process_order');

    return $this->load->view('extension/payment/snapinstmigs', $data);
  ...
  public function process_order() {
    $this->load->model('extension/payment/snapinstmigs');
    ...
    Veritrans_Config::$serverKey = $this->config->
        get('snapinstmigs_server_key');

    Veritrans_Config::$isProduction =
        $this->config->get('snapinstmigs_environment') == 'production'
        ? true : false;
